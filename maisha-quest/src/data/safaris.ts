...
export const SAFARIS: Safari[] = [
  ...
  },
  {
    ...
    gallery: [PHOTOS["wildebeest-migration"], PHOTOS["serengeti-cheetah"], PHOTOS["serengeti-sunset"]],
    featured: true,
    draft: true,
    itinerary: [],
    included: [
  ...
  },
  {
    ...
    gallery: [PHOTOS["kilimanjaro-shira"], PHOTOS["zanzibar-stone-town"], PHOTOS["ngorongoro-crater"]],
    featured: true,
    draft: true,
    itinerary: [],
    included: [
  ...
  },
  {
    ...
    gallery: [PHOTOS["kilimanjaro-shira"], PHOTOS["kilimanjaro-kibo"]],
    draft: true,
    itinerary: [],
    included: [
