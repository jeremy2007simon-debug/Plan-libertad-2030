 ...
 *
 * Son los siete itinerarios de demostración que existían antes de migrar los
 * 18 paquetes reales de maishaquest.com (ver `safaris.ts`). Se conservan aquí,
 * intactos, solo por si alguna de sus estructuras visuales o de itinerario
 * hiciera falta como referencia más adelante. Ninguno de los siete representa
 * un paquete real de Maisha Quest: sus nombres, duraciones y rutas eran
 * inventados para probar el diseño antes de tener el catálogo oficial.
 *
 * Si esto sigue sin usarse dentro de unos meses, se puede borrar sin más.
 *
 * ---------------------------------------------------------------------------
 * Documentación original de este archivo, conservada tal cual:
 * ---------------------------------------------------------------------------
 *
 ...
 */
export const LEGACY_SAFARI_STRUCTURE: SafariStructure[] = [
  {
...
export const LEGACY_SAFARI_SLUGS = LEGACY_SAFARI_STRUCTURE.map((s) => s.slug);
