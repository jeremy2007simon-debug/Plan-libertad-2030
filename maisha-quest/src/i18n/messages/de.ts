...
export const de: Dictionary = {
  ...
  nav: {
    ...
    closeMenu: "Menü schließen",
    siteMenu: "Seitenmenü",
    expandSection: "{label} aufklappen",
    collapseSection: "{label} zuklappen",
    ...
    descriptions: {
      ...
      destinations: "Wo jede Reise beginnt: die Landschaften Nord- und Südtansanias.",
      experiences: "Die Momente zwischen den Camps: zu Fuß, auf dem Wasser und nach Einbruch der Dunkelheit.",
      learn: "Alles, um mit Zuversicht zu planen, Region für Region.",
      about: "Wer wir sind – und warum jede Reise in Arusha beginnt.",
      team: "Die lokalen Experten, die Ihre Reise gestalten und begleiten.",
      impact: "Wohin ein Teil jeder Reise fließt – und warum das zählt.",
      journal: "Feldnotizen, Reiseführer und Geschichten unterwegs.",
    },
    explore: "Entdecken",
  ...
  planner: {
    ...
    fields: {
      ...
      /**
       * Barrierefreie Namen der Reisendenzähler. Vier vollständige Sätze.
       *
       ...
       */
      removeAdult: "Einen Erwachsenen entfernen",
      addAdult: "Einen Erwachsenen hinzufügen",
      removeChild: "Ein Kind entfernen",
    ...
    status: {
      ...
      delivery: {
        rateLimited:
          "Zu viele Anfragen von dieser Verbindung. Warten Sie ein paar Minuten und versuchen Sie es erneut — es ist nichts verloren gegangen.",
        notDelivered:
          "Wir konnten Ihre Anfrage gerade nicht zustellen. Ihre Antworten sind noch da: versuchen Sie es erneut oder senden Sie sie per E-Mail oder WhatsApp.",
        malformed: "Bei dieser Anfrage ist etwas schiefgelaufen. Bitte versuchen Sie es erneut.",
      },
      offline:
  ...
  credits: {
     ...
     */
    ownBody:
      "Von Maisha Quest bereitgestellte Fotografien. Eigentum, Urheberschaft und Nutzungsbedingungen richten sich nach der von dem Unternehmen übergebenen Dokumentation.",
  ...
  categories: {
    "thrill-seeker-adventure": "Nervenkitzel-Abenteuer",
    "water-activities": "Wasseraktivitäten",
    "tours-and-safaris": "Touren & Safaris",
    "shopping-and-leisure": "Shopping und Freizeit",
  ...
  home: {
    ...
    testimonials: {
      ...
      emptyTitle: "Die ersten Erfahrungsberichte unserer Reisenden sind unterwegs.",
      emptyBody:
