...
export const fr: Dictionary = {
  ...
  nav: {
    ...
    expandSection: "Déployer {label}",
    collapseSection: "Réduire {label}",
    ...
    descriptions: {
      ...
      destinations: "Là où commence chaque voyage : les paysages du nord et du sud de la Tanzanie.",
      experiences: "Les moments entre les camps : à pied, sur l’eau et à la tombée de la nuit.",
      learn: "Tout pour préparer votre voyage en toute confiance, région par région.",
      about: "Qui nous sommes, et pourquoi chaque voyage commence à Arusha.",
      team: "Les experts locaux qui conçoivent et guident votre voyage.",
      impact: "Où va une part de chaque voyage, et pourquoi cela compte.",
      journal: "Carnets de route, guides et récits du terrain.",
    },
    explore: "Découvrir",
  ...
  categories: {
    "thrill-seeker-adventure": "Aventure à Sensations",
    "water-activities": "Activités Nautiques",
    "tours-and-safaris": "Circuits et Safaris",
    "shopping-and-leisure": "Shopping et Loisirs",
  ...
  home: {
    ...
    film: {
      eyebrow: "Le film",
      title: "Un pays.\nUne infinité de façons de se sentir vivant.",
    ...
    testimonials: {
      ...
      emptyTitle: "Les premiers récits de nos voyageurs arrivent bientôt.",
      emptyBody:
    ...
    closing: {
      title: "Votre histoire en Tanzanie\ncommence ici.",
