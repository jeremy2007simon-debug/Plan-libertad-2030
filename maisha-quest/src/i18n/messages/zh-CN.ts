...
export const zhCN: Dictionary = {
  ...
  nav: {
    ...
    descriptions: {
      ...
      escape: "开阔、舒适，轻松放松。",
      enrich: "文化、饮食与当地社区。",
      destinations: "每段旅程开始的地方——坦桑尼亚南北的壮丽风景。",
      experiences: "营地之间的时光——徒步、泛舟，或天黑之后。",
      learn: "按地区规划，让您安心出行的全部信息。",
      about: "我们是谁，以及为何每段旅程都始于阿鲁沙。",
      team: "为您设计并全程陪伴的本地专家团队。",
      impact: "每段旅程中的一部分去向何方，以及它为何重要。",
      journal: "来自路途的手记、指南与故事。",
    },
    explore: "探索",
    planCta: "定制我的行程",
  ...
  categories: {
    "thrill-seeker-adventure": "极限冒险",
    "water-activities": "水上活动",
    "tours-and-safaris": "游览与游猎",
    "shopping-and-leisure": "购物与休闲",
    nightlife: "夜生活",
  },
  languageNames: {
    English: "英语",
