...
export const es: Dictionary = {
  ...
  nav: {
    ...
    expandSection: "Desplegar {label}",
    collapseSection: "Contraer {label}",
    ...
    descriptions: {
      ...
      destinations: "Dónde empieza cada viaje: los paisajes del norte y el sur de Tanzania.",
      experiences: "Los momentos entre campamentos: a pie, en el agua y al caer la noche.",
      learn: "Todo lo necesario para planificar con confianza, región a región.",
      about: "Quiénes somos y por qué cada viaje empieza en Arusha.",
      team: "Los expertos locales que diseñan y guían tu viaje.",
      impact: "A dónde va parte de cada viaje, y por qué importa.",
      journal: "Notas de campo, guías e historias del camino.",
    },
    explore: "Explorar",
  ...
  planner: {
    ...
    fields: {
      ...
      /**
       * Nombres accesibles de los contadores de viajeros. Cuatro frases completas: componerlas uniendo un verbo a la etiqueta del campo daba «Un adultos menos».
       *
       ...
       */
      removeAdult: "Quitar un adulto",
      addAdult: "Añadir un adulto",
      removeChild: "Quitar un niño",
    ...
    status: {
      ...
      delivery: {
        rateLimited:
          "Demasiadas solicitudes desde esta conexión. Espera unos minutos y vuelve a intentarlo: no se ha perdido nada.",
        notDelivered:
          "No hemos podido entregar tu solicitud ahora mismo. Tus respuestas siguen aquí: inténtalo otra vez, o mándalas por correo o WhatsApp.",
        malformed: "Algo ha fallado con esa solicitud. Inténtalo de nuevo.",
      },
      offline:
  ...
  credits: {
     ...
     */
    ownBody:
      "Fotografías suministradas por Maisha Quest. La titularidad, autoría y condiciones de uso se mantienen según la documentación facilitada por la empresa.",
  ...
  categories: {
    "thrill-seeker-adventure": "Aventura Extrema",
    "water-activities": "Actividades Acuáticas",
    "tours-and-safaris": "Tours y Safaris",
    "shopping-and-leisure": "Compras y Ocio",
  ...
  home: {
    ...
    film: {
      eyebrow: "La película",
      title: "Un país.\nInfinitas formas de sentirse vivo.",
      watch: "Ver el viaje",
