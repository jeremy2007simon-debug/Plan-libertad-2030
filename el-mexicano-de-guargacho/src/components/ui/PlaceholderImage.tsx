...
export function PlaceholderImage({
  ...
  return (
    ...
    >
      ...
      />
      {/* Fondo interno siempre oscuro (foto pendiente) — texto fijo en
          cream, no en --ink, para seguir leyéndose sin importar la
          paleta clara/oscura del resto de la página. */}
      <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 text-cream-dim-2">
