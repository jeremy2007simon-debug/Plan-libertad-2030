const paths = {
  ...
  plate: "M12 4a8 8 0 1 0 0 16 8 8 0 0 0 0-16Zm0 3a5 5 0 1 0 0 10 5 5 0 0 0 0-10Z",
  taco: "M3 13a9 5 0 0 1 18 0M3 13c1.5 1.5 3 1.5 4.5 0s3-1.5 4.5 0 3 1.5 4.5 0 3-1.5 4.5 0",
  skillet: "M3 14a6 6 0 1 0 12 0 6 6 0 0 0-12 0Zm12-1h7",
  burrito:
    "M6 8h12a4 4 0 0 1 0 8H6a4 4 0 0 1 0-8ZM9 9l1.5 6M13 9l1.5 6M17 9l1 6",
  enchilada:
    "M3 8h18v8a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8Zm5 1v7m4-7v7m4-7v7M3 8c1-1.5 2 .5 3-.5s2-1 3 .5 2 1 3-.5 2-1 3 .5",
  cocktail: "M4 4h16L12 13v7m-4 0h8",
  dessert: "M5 19h14M5 19 9 10h6l4 9M6.5 15h11M12 10V7l1 1",
  sparkles:
  ...
  tiktok:
    "M15 3v10.8a4 4 0 1 1-3.2-3.92V13a1.2 1.2 0 1 0 1.2 1.2V3h2Zm0 0c.4 2.6 2.2 4.4 4.8 4.7v2.6c-1.8-.1-3.4-.7-4.8-1.7",
  whatsapp:
